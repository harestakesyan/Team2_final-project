...
By exploring the data, we found that the most noticeable differences between people who have cardiovascular disease and people who do not have cardiovascular disease were in cholesterol and glucose. `r 100 - (sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100))`% of people with cardiovascular disease have above normal cholesterol levels, while only xx% of people **without** the disease have above normal cholesterol.

`r sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100)`% of people with cardiovascular disease are women and `r sprintf("%.1f", (sum(healthy$gender=="1")/nrow(disease)) * 100)`% of people who *do not* have cardiovascular disease are women.
we found that `r sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100)`% of people with cardiovascular disease are women and `r sprintf("%.1f", (sum(healthy$gender=="1")/nrow(disease)) * 100)`% of people who *do not* have cardiovascular disease are women.
we found that `r sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100)`% of people with cardiovascular disease are women and `r sprintf("%.1f", (sum(healthy$gender=="1")/nrow(disease)) * 100)`% of people who *do not* have cardiovascular disease are women.
we found that `r sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100)`% of people with cardiovascular disease are women and `r sprintf("%.1f", (sum(healthy$gender=="1")/nrow(disease)) * 100)`% of people who *do not* have cardiovascular disease are women.
we found that `r sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100)`% of people with cardiovascular disease are women and `r sprintf("%.1f", (sum(healthy$gender=="1")/nrow(disease)) * 100)`% of people who *do not* have cardiovascular disease are women.
we found that `r sprintf("%.1f", (sum(disease$gender=="1")/nrow(disease)) * 100)`% of people with cardiovascular disease are women and `r sprintf("%.1f", (sum(healthy$gender=="1")/nrow(disease)) * 100)`% of people who *do not* have cardiovascular disease are women.
...
## Chi-Squared Test
What was the purpose of the chi-squared test? We use a chi-square test to evaluate
